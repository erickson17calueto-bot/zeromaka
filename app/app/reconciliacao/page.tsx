...
export default function ReconciliacaoPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3"><div className="card p-4"><div className="text-[12.5px] text-ink-400 font-medium">Linhas visíveis</div><div className="text-2xl font-semibold tracking-tight tabular-nums mt-1">{visibleLines.length}</div></div><div className="card p-4"><div className="text-[12.5px] text-ink-400 font-medium">Por confirmar</div><div className="text-2xl font-semibold tracking-tight tabular-nums mt-1 text-amber-400">{unmatched}</div></div><div className="card p-4"><div className="text-[12.5px] text-ink-400 font-medium">Reconciliadas</div><div className="text-2xl font-semibold tracking-tight tabular-nums mt-1 text-emerald-400">{matched}</div></div></div>
