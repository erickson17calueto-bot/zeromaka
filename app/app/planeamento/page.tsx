...
export default function PlaneamentoPage() {
  ...
  return <div className="max-w-6xl mx-auto space-y-6">
    ...
    {forecast && <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3"><div className="card p-4"><div className="text-[11px] uppercase tracking-wider text-ink-500 font-bold">Saldo inicial</div><div className="font-display text-xl mt-1">{fmtKz(forecast.opening_balance)}</div></div><div className="card p-4"><div className="text-[11px] uppercase tracking-wider text-ink-500 font-bold">Entradas projetadas</div><div className="font-display text-xl mt-1 text-emerald-400">{fmtKz(forecast.actual_inflows + forecast.scheduled_inflows + forecast.receivables_due)}</div><div className="text-[11px] text-ink-500 mt-1">Real + recorrente + a receber</div></div><div className="card p-4"><div className="text-[11px] uppercase tracking-wider text-ink-500 font-bold">Saídas projetadas</div><div className="font-display text-xl mt-1 text-red-400">{fmtKz(forecast.actual_outflows + forecast.scheduled_outflows + forecast.payables_due)}</div><div className="text-[11px] text-ink-500 mt-1">Real + recorrente + a pagar</div></div><div className="card p-4"><div className="text-[11px] uppercase tracking-wider text-ink-500 font-bold">Fecho projetado</div><div className={`font-display text-xl mt-1 ${forecast.projected_closing_balance >= 0 ? "text-maka-400" : "text-red-400"}`}>{fmtKz(forecast.projected_closing_balance)}</div></div></div>}
